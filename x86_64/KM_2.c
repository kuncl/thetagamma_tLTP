...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 KM /home2/hjang/Research/AD_OPTO_GAMMA/Evolution_Algorithm_Fit/neuron_code_tLTP/mod/x86_64/KM_2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
 static double _zuexp ;
 static double _zq10 ;
...
static int  _f_rates (  double _lv ) {
  ...
  _zq10 = pow( 5.0 , ( ( celsius - 23.0 ) / 10.0 ) ) ;
   _lalpha = 0.016 / exp ( ( _lv + 52.7 ) / - 23.0 ) ;
   _lbeta = 0.016 / exp ( ( _lv + 52.7 ) / 18.8 ) ;
   _lsum = _lalpha + _lbeta ;
   uinf = _lalpha / _lsum ;
   utau = timesTau / ( _lsum * _zq10 ) + plusTau ;
    return 0; }
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 45 in file KM_2.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
static void _initlists() {
 ...
 _slist1[0] = &(u) - _p;  _dlist1[0] = &(Du) - _p;
   _t_uinf = makevector(3001*sizeof(double));
   _t_utau = makevector(3001*sizeof(double));
_first = 0;
}
