...
#define nrn_init _nrn_init__Ifluct1
#define _nrn_initial _nrn_initial__Ifluct1
#define nrn_cur _nrn_cur__Ifluct1
#define _nrn_current _nrn_current__Ifluct1
#define nrn_jacob _nrn_jacob__Ifluct1
#define nrn_state _nrn_state__Ifluct1
#define _net_receive _net_receive__Ifluct1 
#define oup oup__Ifluct1 
#define setRandObj setRandObj__Ifluct1 
...
#define randGen randGen_Ifluct1
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Ifluct1 /home2/hjang/Research/AD_OPTO_GAMMA/Evolution_Algorithm_Fit/neuron_code_tLTP/mod/x86_64/NewNoise.mod\n");
...
static int  oup ( _threadargsproto_ ) {
   if ( tau > 0.0 ) {
     x = x + ( 1. - exp ( - dt / tau ) ) * ( m - x ) + sqrt ( 1. - exp ( - 2. * dt / tau ) ) * s * noise ;
     }
    return 0; }
...
static int _ode_count(int _type){ hoc_execerror("Ifluct1", "cannot be used with CVODE"); return 0;}
