...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 IClampNoise /home3/hjang/AD_OPTO_GAMMA/Evolution_Algorithm_Fit/neuron_code_tLTP_test_rev1/mod/x86_64/IClampNoise.mod\n");
