...
#define nrn_init _nrn_init__kmP
#define _nrn_initial _nrn_initial__kmP
#define nrn_cur _nrn_cur__kmP
#define _nrn_current _nrn_current__kmP
#define nrn_jacob _nrn_jacob__kmP
#define nrn_state _nrn_state__kmP
#define _net_receive _net_receive__kmP 
#define _f_trates _f_trates__kmP 
#define rates rates__kmP 
#define states states__kmP 
#define trates trates__kmP 
...
extern Memb_func* memb_func;
 ...
 "setdata_kmP", _hoc_setdata,
 "rates_kmP", _hoc_rates,
 "states_kmP", _hoc_states,
 "trates_kmP", _hoc_trates,
 0, 0
};
...
#define tha tha_kmP
 double tha = -30;
#define tadj tadj_kmP
 double tadj = 0;
#define temp temp_kmP
 double temp = 23;
#define usetable usetable_kmP
 double usetable = 1;
#define vmax vmax_kmP
 double vmax = 100;
#define vmin vmin_kmP
 double vmin = -120;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
 	...
 	ivoc_help("help ?1 kmP /home2/hjang/Research/AD_OPTO_GAMMA/Evolution_Algorithm_Fit/neuron_code_tLTP/mod/x86_64/km.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("kmP", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 65 in file km.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
