...
#define nrn_init _nrn_init__na3n
#define _nrn_initial _nrn_initial__na3n
#define nrn_cur _nrn_cur__na3n
#define _nrn_current _nrn_current__na3n
#define nrn_jacob _nrn_jacob__na3n
#define nrn_state _nrn_state__na3n
#define _net_receive _net_receive__na3n 
#define states states__na3n 
#define trates trates__na3n 
...
extern Memb_func* memb_func;
 ...
 "setdata_na3n", _hoc_setdata,
 "alps_na3n", _hoc_alps,
 "alpv_na3n", _hoc_alpv,
 "bets_na3n", _hoc_bets,
 "trap0_na3n", _hoc_trap0,
 "trates_na3n", _hoc_trates,
 0, 0
};
#define alps alps_na3n
#define alpv alpv_na3n
#define bets bets_na3n
#define trap0 trap0_na3n
...
#define gms gms_na3n
 double gms = 0.2;
#define hmin hmin_na3n
 double hmin = 0.5;
#define htau htau_na3n
 double htau = 0;
#define hinf hinf_na3n
 double hinf = 0;
#define mmin mmin_na3n
 double mmin = 0.02;
#define mtau mtau_na3n
 double mtau = 0;
#define minf minf_na3n
 double minf = 0;
#define qq qq_na3n
 double qq = 10;
#define q10 q10_na3n
...
#define qa qa_na3n
 double qa = 7.2;
#define qinf qinf_na3n
 double qinf = 4;
#define smax smax_na3n
 double smax = 10;
#define sinf sinf_na3n
 double sinf = 0;
#define tq tq_na3n
 double tq = -55;
#define thi2 thi2_na3n
 double thi2 = -45;
#define thi1 thi1_na3n
 double thi1 = -45;
#define tha tha_na3n
 double tha = -30;
#define thinf thinf_na3n
 double thinf = -50;
#define taus taus_na3n
 double taus = 0;
#define vvs vvs_na3n
 double vvs = 2;
#define vvh vvh_na3n
 double vvh = -58;
#define vhalfs vhalfs_na3n
 double vhalfs = -60;
#define zetas zetas_na3n
 double zetas = 12;
 ...
 "qq_na3n", &qq_na3n,
 "tq_na3n", &tq_na3n,
 "thinf_na3n", &thinf_na3n,
 "qinf_na3n", &qinf_na3n,
 "vhalfs_na3n", &vhalfs_na3n,
 "vvh_na3n", &vvh_na3n,
 "a0s_na3n", &a0s_na3n,
 "zetas_na3n", &zetas_na3n,
 "gms_na3n", &gms_na3n,
 "smax_na3n", &smax_na3n,
 "vvs_na3n", &vvs_na3n,
 "minf_na3n", &minf_na3n,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na3n /home2/hjang/Research/AD_OPTO_GAMMA/Evolution_Algorithm_Fit/neuron_code_tLTP/mod/x86_64/na3n.mod\n");
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 71 in file na3n.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
