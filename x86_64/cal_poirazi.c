...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "ca_ion");
 	...
 	ivoc_help("help ?1 calH /home2/hjang/Research/AD_OPTO_GAMMA/Evolution_Algorithm_Fit/neuron_code_tLTP/mod/x86_64/cal_poirazi.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 39 in file cal_poirazi.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
 } }}
